...
catalog_url = data_url + '/TS_3pt.fits'
...
with tf.device('/GPU:0'):
	...
	with open('/home/wroster/learning-photoz/PICZL_OZ/train_PICZL/output/' + lf + '/preds/' + version + '/preds.pkl', 'wb') as file:
...
#############################################################################
'''
with open('/home/wroster/learning-photoz/PICZL_OZ/train_PICZL/output/' + lr + '/preds/' + version + '/preds.pkl', 'rb') as pickle_file:
