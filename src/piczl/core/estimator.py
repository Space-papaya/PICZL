...
def run_estimation(catalog_path, image_path, mode, sub_sample, max_sources, pdf_samples=4001):
    ...
    with tf.device('/GPU:0'):
        ...
        dataset, image_data = fetch_inputs.fetch_all_data(catalog_path, image_path, exec='run', psf=psf, sub_sample_yesno=sub_sample, sub_sample_size=max_sources)
        ...
        norm_ens_pdfs, z_modes, areas = pdf_distributions.ensemble_pdfs(normalized_weights, all_pdfs, samples)
