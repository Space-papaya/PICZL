...
files = glob.glob('dered_griz_model_*')
...
np.save('/home/wroster/learning-photoz/PICZL_OZ/run_PICZL/files/FLASH_comp/dered_griz_model.npy', concatenated)
