...
def clean_obs(images_g, images_r, images_i, images_z):
	...
	np.save('/home/wroster/learning-photoz/PICZL_OZ/run_PICZL/files/FLASH/clean_dered_griz.npy', clean_griz)
...
def clean_cols(images_g, images_r, images_i, images_z):
	...
	np.save('/home/wroster/learning-photoz/PICZL_OZ/run_PICZL/files/FLASH/clean_griz_cols.npy', clean_griz_cols)
