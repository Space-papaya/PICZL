...
def grab_features(dataset):
	...
	features_dered_flux = np.array(features.iloc[:,[6,18,30,42]]) #only WISE, after adding model image for g,r,i,z
	...
	features_col = np.array(features.iloc[:, 213:235]) #removed griz and w1-w4 colours, substituted by images
